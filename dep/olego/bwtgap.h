...
typedef struct { // recursion stack
	...
	u_int32_t n_mm:8, n_gapo_t:8, n_gape_t:8, n_gapo_q:8, n_gape_q:8;
	//mismatch, gap opening and extension in target and query sequences respectively
	u_int32_t state:2, n_seed_mm:6;
